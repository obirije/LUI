...
| **FULL** | 112 | + SMS, calls, screen control, downloads — trusted agents only |
...
- Models with tool/function calling support (Qwen 2.5, Llama 3.1, Mistral Nemo) work with all 112 LUI tools
